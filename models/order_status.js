...
OrderStatusSchema.statics = {
	...
	new: function (req){
		console.log("Calling model : order_status /  method = new ");
		var module = mongoose.model('OrderStatus', OrderStatusSchema);
		return new module({
  ...
  load: function (order , req) {
		console.log("Calling model : OrderStatus /  method = load ");
    // order = req.body;
